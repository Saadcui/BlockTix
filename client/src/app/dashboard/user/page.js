    ...
    return (
      <div className="bg-black/5 dark:bg-white/10 backdrop-blur-md border border-black/10 dark:border-white/10 rounded-lg shadow-md hover:shadow-lg hover:shadow-[#FFA500]/20 transition w-full overflow-hidden relative">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-700 dark:text-white/70 text-sm mt-1">
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gray-900/80 border border-white/10 text-white rounded-3xl shadow-2xl max-w-3xl w-full p-6 md:p-8 relative overflow-hidden backdrop-blur-xl">
              <button
                ...
                className="absolute top-4 right-4 text-black hover:text-grey p-2"
              >
                ✕
              </button>
              ...
              <div className="text-center">
                    ...
                    <div className="text-left">
                      ...
                      <div className="mt-3 bg-white/5 rounded-2xl border border-white/10 shadow-sm p-3 flex items-center justify-center">
                        {qrToken ? (
                          ...
                          <div className="w-[140px] h-[140px] flex items-center justify-center text-white/60 text-sm">
                            Generating...
                          </div>
                        )}
                      </div>
                    ...
                    <div className="mt-5">
                      <div className="h-10 rounded-xl bg-white/5 border border-white/10 overflow-hidden flex">
                        {Array.from({ length: 36 }).map((_, i) => (
                          <div
                            key={i}
                            className={`h-full ${i % 3 === 0 ? 'w-[3px]' : 'w-[2px]'} ${i % 4 === 0 ? 'bg-white/70' : 'bg-white/20'}`}
                          />
                        ))}
                      </div>
                ...
                <div className="space-y-3">
                  ...
                  {selectedTicket.custodial ? (
                      ...
                      {selectedTicket.isForResale && (
                        <>
                          ...
                          <button
                            ...
                            disabled={delisting}
                            className="w-full py-2.5 text-sm bg-red-500/10 border border-red-400/20 text-red-200 rounded-lg font-semibold hover:bg-red-500/15 transition disabled:opacity-50"
                          >
                    ...
                    <>
                      <div className="p-4 bg-green-500/10 text-green-200 rounded-xl text-sm font-medium border border-green-400/20 mb-3">
